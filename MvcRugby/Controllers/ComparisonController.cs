...
namespace MvcRugby.Controllers
{
    ...
    {       
        ...
        public async Task<IActionResult> Index()
        {
            ...
            var competitions = await _rugbyDataApiService.GetCompetitions();
        ...
        public async Task<IActionResult> CompRounds(string? id)
        {
            ...
            var CompetitionRounds = await _rugbyDataApiService.GetCompetitionRounds(id);
        ...
        {
            // Get SportsRadar data from API via services, using id passed from Index() view by the user selection
            var roundLineup = await _rugbyDataApiService.GetRoundLineup(id);
